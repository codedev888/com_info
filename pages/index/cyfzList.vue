<template>
	<view class="main">
		...
		<view class="tabs">
			<view class="tabs-t u-border-bottom" style="padding: 0 50rpx;">
			...
			<swiper class="tabs_s" :current="swiperCurrent" @transition="transition" @animationfinish="animationfinish">
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100%;width: 100%;" @scrolltolower="onreachBottom" @scroll="function (e){return scroll(e, 0)}">
						<view class="zcfg">
							<view class="zcfg-c an" :class="{sticky:sticky[0]}">
								<view class="choose u-border">
									<u-dropdown ref="uDropdown">
										<u-dropdown-item v-model="value1" title="发布地区" :options="options1" height="600">
										</u-dropdown-item>
										<u-dropdown-item v-model="value2" title="发布时间" :options="options2">
										</u-dropdown-item>
										<u-dropdown-item v-model="value3" title="默认排序" :options="options3">
										</u-dropdown-item>
									</u-dropdown>
								</view>
								<view class="type">
				...
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100%;width: 100%;" @scrolltolower="onreachBottom" @scroll="function (e){return scroll(e, 1)}">
						<view class="zcfg">
							<view class="zcfg-c" :class="{sticky:sticky[1]}">
								<view class="choose u-border">
									<u-dropdown ref="uDropdown">
										...
										<u-dropdown-item v-model="value5" title="主管部门" :options="options5">
										</u-dropdown-item>
										<u-dropdown-item v-model="value6" title="默认排序" :options="options6">
										</u-dropdown-item>
									</u-dropdown>
								</view>
							</view>
